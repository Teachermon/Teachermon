class Player {
  ...
  void move(){
    ...
    if (mover==true) {
      movetimer++;
      if (x!=width-50 && (x!=width/4-25 || y!=25) && (x!=2*width/4-25 || y!=25) && (x!=3*width/4-25 || y!=25)){
        x++;
      }
      if (movetimer==25) {
        mover=false;
    ...
    if (movel==true) {
      movetimer++;
      if(x!=25 && (x!=width/4+25 || y!=25) && (x!=2*width/4+25 || y!=25) && (x!=3*width/4+25 || y!=25)){
        x--;
      }
      if (movetimer==25) {
        movel=false;
    ...
    if (moveu==true) {
      movetimer++;
      if(y!=25 && (x!=width/4 || y!=50) && (x!=2*width/4 || y!=50) && (x!=3*width/4 || y!=50)){
        y--;
      }
      if (movetimer==25) {
        moveu=false;
